...
import 'package:flutter_store_shoe/views/shared/loading.dart';
...
class _LoginScreenState extends State<LoginView> {
  ...
  final LoadingView loadingManager = LoadingView();
                  ...
                  children: [
                    Row(
                      children: [
                        Theme(
                          data: ThemeData(
                            unselectedWidgetColor: const Color(0x666F767D),
                          ),
                          child: Checkbox(
